...
export const dialogueData = {
  pc: `This is my computer. Now I'm mostly learning React with TypeScript.
  I've done a few assignments throughout my studies, including topics on creating ToDo apps, paginated web pages, and more.
  My goal is to move towards becoming a Fullstack developer.
  Here is my <a href="https://github.com/AnastasiiaHombalevska" target="_blank">Github</a>!`,

  "cs-degree": `This is my diploma in psychology. Because working as a psychologist in the education system is a period of life in which there is something to remember and tell.`,

  "sofa-table": `That's my sofa. This is a very functional object. It is a work area, for example, the text you are reading now was written here. A place to relax with reading The Hobbit. A place to procrastinate by counting dots on the ceiling, and so on, depending on the request&#128512`,
  ...
  This is also where I sleep, of course. Great ideas come to me in the middle of the night. When an idea comes to me, I often have to write it down, otherwise I won't be able to sleep.`,
